#Restaurante que no funciona, no fui capaz---------------------

acumuladoMesa1=0
pedidoMesa1=0
incrementadorMesa1=0
impuestoImpoconsumo=0


pedidoMesa1=int(input("Se te ha asignado la mesa 1, ingresa el precio de tu pedido"))
while pedidoMesa1>0:
    impuestoImpoconsumo=((pedidoMesa1/100)*8)
    acumuladoMesa1=(acumuladoMesa1+pedidoMesa1+impuestoImpoconsumo)
print ("tu factura actual es ", acumuladorMesa1)

pedidoMesa2=int(input("Se te ha asignado la mesa 1, ingresa el precio de tu pedido"))
while pedidoMesa1>0:
    impuestoImpoconsumo=((pedidoMesa1/100)*8)
    acumuladoMesa1=(acumuladoMesa1+pedidoMesa1+impuestoImpoconsumo)
print ("tu factura actual es ", acumuladorMesa1)
    
pedidoMesa3=int(input("Se te ha asignado la mesa 1, ingresa el precio de tu pedido"))
while pedidoMesa1>0:
    impuestoImpoconsumo=((pedidoMesa1/100)*8)
    acumuladoMesa1=(acumuladoMesa1+pedidoMesa1+impuestoImpoconsumo)
print ("tu factura actual es ", acumuladorMesa1)

pedidoMesa4=int(input("Se te ha asignado la mesa 1, ingresa el precio de tu pedido"))
while pedidoMesa1>0:
    impuestoImpoconsumo=((pedidoMesa1/100)*8)
    acumuladoMesa1=(acumuladoMesa1+pedidoMesa1+impuestoImpoconsumo)
print ("tu factura actual es ", acumuladorMesa1)

pedidoMesa5=int(input("Se te ha asignado la mesa 1, ingresa el precio de tu pedido"))
while pedidoMesa1>0:
    impuestoImpoconsumo=((pedidoMesa1/100)*8)
    acumuladoMesa1=(acumuladoMesa1+pedidoMesa1+impuestoImpoconsumo)
print ("tu factura actual es ", acumuladorMesa1)

pedidoMesa6=int(input("Se te ha asignado la mesa 1, ingresa el precio de tu pedido"))
while pedidoMesa1>0:
    impuestoImpoconsumo=((pedidoMesa1/100)*8)
    acumuladoMesa1=(acumuladoMesa1+pedidoMesa1+impuestoImpoconsumo)
print ("tu factura actual es ", acumuladorMesa1)

pedidoMesa7=int(input("Se te ha asignado la mesa 1, ingresa el precio de tu pedido"))
while pedidoMesa1>0:
    impuestoImpoconsumo=((pedidoMesa1/100)*8)
    acumuladoMesa1=(acumuladoMesa1+pedidoMesa1+impuestoImpoconsumo)
print ("tu factura actual es ", acumuladorMesa1)

pedidoMesa8=int(input("Se te ha asignado la mesa 1, ingresa el precio de tu pedido"))
while pedidoMesa1>0:
    impuestoImpoconsumo=((pedidoMesa1/100)*8)
    acumuladoMesa1=(acumuladoMesa1+pedidoMesa1+impuestoImpoconsumo)
print ("tu factura actual es ", acumuladorMesa1)

pedidoMesa9=int(input("Se te ha asignado la mesa 1, ingresa el precio de tu pedido"))
while pedidoMesa1>0:
    impuestoImpoconsumo=((pedidoMesa1/100)*8)
    acumuladoMesa1=(acumuladoMesa1+pedidoMesa1+impuestoImpoconsumo)
print ("tu factura actual es ", acumuladorMesa1)

pedidoMesa10=int(input("Se te ha asignado la mesa 1, ingresa el precio de tu pedido"))
while pedidoMesa1>0:
    impuestoImpoconsumo=((pedidoMesa1/100)*8)
    acumuladoMesa1=(acumuladoMesa1+pedidoMesa1+impuestoImpoconsumo)
print ("tu factura actual es ", acumuladorMesa1)

pedidoMesa11=int(input("Se te ha asignado la mesa 1, ingresa el precio de tu pedido"))
while pedidoMesa1>0:
    impuestoImpoconsumo=((pedidoMesa1/100)*8)
    acumuladoMesa1=(acumuladoMesa1+pedidoMesa1+impuestoImpoconsumo)
print ("tu factura actual es ", acumuladorMesa1)

pedidoMesa12=int(input("Se te ha asignado la mesa 1, ingresa el precio de tu pedido"))
while pedidoMesa1>0:
    impuestoImpoconsumo=((pedidoMesa1/100)*8)
    acumuladoMesa1=(acumuladoMesa1+pedidoMesa1+impuestoImpoconsumo)
print ("tu factura actual es ", acumuladorMesa1)

pedidoMesa13=int(input("Se te ha asignado la mesa 1, ingresa el precio de tu pedido"))
while pedidoMesa1>0:
    impuestoImpoconsumo=((pedidoMesa1/100)*8)
    acumuladoMesa1=(acumuladoMesa1+pedidoMesa1+impuestoImpoconsumo)
print ("tu factura actual es ", acumuladorMesa1)

pedidoMesa14=int(input("Se te ha asignado la mesa 1, ingresa el precio de tu pedido"))
while pedidoMesa1>0:
    impuestoImpoconsumo=((pedidoMesa1/100)*8)
    acumuladoMesa1=(acumuladoMesa1+pedidoMesa1+impuestoImpoconsumo)
print ("tu factura actual es ", acumuladorMesa1)

pedidoMesa15=int(input("Se te ha asignado la mesa 1, ingresa el precio de tu pedido"))
while pedidoMesa1>0:
    impuestoImpoconsumo=((pedidoMesa1/100)*8)
    acumuladoMesa1=(acumuladoMesa1+pedidoMesa1+impuestoImpoconsumo)
print ("tu factura actual es ", acumuladorMesa1)

pedidoMesa16=int(input("Se te ha asignado la mesa 1, ingresa el precio de tu pedido"))
while pedidoMesa1>0:
    impuestoImpoconsumo=((pedidoMesa1/100)*8)
    acumuladoMesa1=(acumuladoMesa1+pedidoMesa1+impuestoImpoconsumo)
print ("tu factura actual es ", acumuladorMesa1)

pedidoMesa17=int(input("Se te ha asignado la mesa 1, ingresa el precio de tu pedido"))
while pedidoMesa1>0:
    impuestoImpoconsumo=((pedidoMesa1/100)*8)
    acumuladoMesa1=(acumuladoMesa1+pedidoMesa1+impuestoImpoconsumo)
print ("tu factura actual es ", acumuladorMesa1)

pedidoMesa18=int(input("Se te ha asignado la mesa 1, ingresa el precio de tu pedido"))
while pedidoMesa1>0:
    impuestoImpoconsumo=((pedidoMesa1/100)*8)
    acumuladoMesa1=(acumuladoMesa1+pedidoMesa1+impuestoImpoconsumo)
print ("tu factura actual es ", acumuladorMesa1)

pedidoMesa19=int(input("Se te ha asignado la mesa 1, ingresa el precio de tu pedido"))
while pedidoMesa1>0:
    impuestoImpoconsumo=((pedidoMesa1/100)*8)
    acumuladoMesa1=(acumuladoMesa1+pedidoMesa1+impuestoImpoconsumo)
print ("tu factura actual es ", acumuladorMesa1)

pedidoMesa20=int(input("Se te ha asignado la mesa 1, ingresa el precio de tu pedido"))
while pedidoMesa1>0:
    impuestoImpoconsumo=((pedidoMesa1/100)*8)
    acumuladoMesa1=(acumuladoMesa1+pedidoMesa1+impuestoImpoconsumo)
print ("tu factura actual es ", acumuladorMesa1)
...
while salaConSubtitulosEspañol<361 and salaConSubtitulosIngles<361 and peliculasHD<361 and peliculas3D<361:
    ...
    if salaConSubtitulosEspañol>=360 and salaConSubtitulosIngles>=360 and peliculasHD>=360 and peliculas3D>=360:        
        break
