...
def calcularVentasAdultos (boletasNiñosCompradas):
    gananciasBoletasAdultos = boletasAdultosCompradas * 10000
    return gananciasBoletasNiños

def calcularGananciasTotales (gananciasBoletasNiños, gananciasBoletasAdultos):
    gananciasTotales=ganaciasBoletasNiños+gananciasBoletasAdultos
