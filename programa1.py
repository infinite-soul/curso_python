...
def calcular_dinero(plata):
    # Denominaciones de mayor a menor
    denominaciones = [
        100000,
        50000,
        20000,
    ...
    # Calcular cuántos billetes y monedas se entregan
...
def cajero(plata):
    ...
    print(f"\nTu dinero es: {plata:,} pesos")

    entrega, restante = calcular_dinero(plata)
